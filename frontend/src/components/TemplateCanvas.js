  ...
  const renderElementContent = (element) => {
    switch (element.type) {
      ...
      case 'remarksBlock': {
        ...
        const styledCanvasHTML = `
          <div class="rtx-apply" style="line-height: ${element.lineHeight || 1.4};">
            ${displayHTML}
          </div>
        `;
        return (
          <div
            ...
            dangerouslySetInnerHTML={{ __html: styledCanvasHTML }}
          />
        );
      }
          ...
          <table style={{ width: '100%', fontSize: `${element.fontSize}px`, pointerEvents: 'none', userSelect: 'none', border: 'none', background: 'transparent' }}>
            ...
            <tbody>
              <tr style={{ background: 'transparent', border: 'none' }}>
                ...
                <td style={{ padding: '8px', textAlign: 'left', background: 'transparent', verticalAlign: 'top', whiteSpace: 'pre-wrap', wordWrap: 'break-word', lineHeight: '1.4', border: 'none' }}>
  ...
  return (
    <div className="canvas-container">
      <div className="canvas-wrapper">
        ...
        >
          {/* Ensure consistent line-height inheritance for rich text */}
          <style>
            {`
              .canvas .rtx-apply, .canvas .rtx-apply * {
                margin: 0 !important;
                padding: 0 !important;
